...
*/
let nota1 = 8.5; // Primeira nota parcial
let nota2 = 6.0; // Segunda nota parcial
let media = (nota1 + nota2) / 2; // Cálculo da média
let conceito;
...
console.log(`\nConceitos: A (9.0 a 10.0), B (7.5 a 9.0), C (6.0 a 7.5), D (4.0 a 6.0), E (0 a 4.0)`); // Explicação dos conceitos

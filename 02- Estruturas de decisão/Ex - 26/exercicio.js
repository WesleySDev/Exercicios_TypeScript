...
*/
let precoProduto1 = 50.0;
let precoProduto2 = 30.0;
let precoProduto3 = 40.0;
...
console.log(`Preço do ${produtoMaisBarato}: R$ ${Math.min(precoProduto1, precoProduto2, precoProduto3).toFixed(2)}`); // Exibe o preço do produto mais barato

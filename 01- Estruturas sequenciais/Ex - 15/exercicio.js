...
*/
let ganhoPorHora = 20; // Ganho por hora
let horasTrabalhadas = 160; // Horas trabalhadas no mês
let salarioBruto = ganhoPorHora * horasTrabalhadas; // Cálculo do salário bruto
let descontoIR = salarioBruto * 0.11; // Desconto do Imposto de Renda (11%)
let descontoINSS = salarioBruto * 0.08; // Desconto do INSS (8%)
let descontoSindicato = salarioBruto * 0.05; // Desconto do sindicato (5%)
let salarioLiquido = salarioBruto - (descontoIR + descontoINSS + descontoSindicato); // Cálculo do salário líquido
